...
public class MagicLightSource_Level3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        QuadObject1 = GameObject.Find("Quad_Mercury");
        ...
        endObject = GameObject.Find("Cube_Level3");
    ...
    private void particleEffect()
    {
        ...
        else if (destroyedObject.name == "Quad_Mercury")
        {
